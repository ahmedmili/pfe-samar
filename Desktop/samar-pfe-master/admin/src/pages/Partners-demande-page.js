...
export default class DemandePartnersPage extends React.Component {
    ...
    initDAta(){
        ...
        fetch("http://localhost:8080/api/partners/list-demande", requestOptions)
    ...
    AcceptPartner(id){
        ...
        fetch("http://localhost:8080/api/partners-accept?id="+id, requestOptions)
        .then(response => response.json())
        .then(result =>{
            this.initDAta();
        }) 
